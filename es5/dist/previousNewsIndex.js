...
/***/function (module, exports, __webpack_require__) {
  ...
  ***********************************************/
	...
	(function () {
		...
		/**----------===| MODULE: TESTIMONIALS |===----------**/
		var previousNewsSection = __webpack_require__(10);
...
/***/function (module, exports, __webpack_require__) {
  ...
  ***********************************************/
	...
	(function () {
		...
		var previousNewsContainerClass = $(".previousNewsContainerClass");
		var previousNewsContainerId = $("#previousNewsContainerId");

		var fPreviousNewsAjax = function fPreviousNewsAjax() {
			var promise = $.get("./js/json/previousNews.json");
			promise.then(function (data) {
				...
				try {
					for (var _iterator5 = data.PreviousNewsListContent[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
						var prevNews = _step5.value;
						...
						var previousNewsTitleContainerId = document.getElementById("previousNewsTitleContainer" + "Id_" + jx);
						...
						try {
							for (var _iterator6 = prevNews.previousNews[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
								var previousNews = _step6.value;

								ji++;
								createDiv.fCreateTag("div", "previousNewsContainer", "previousNewsContainerClass", ji, previousNewsContainerId);
								var previousNewsContId = document.getElementById("previousNewsContainer" + "Id_" + ji);
